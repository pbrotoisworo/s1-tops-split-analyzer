...
data3 = os.path.join(TEST_DIR, 'data3', 'S1A_IW_SLC__1SDV_20200724T034334_20200724T034401_033591_03E49D_96AA.SAFE', 'mainfest.safe')
...
# Using data3 folder
def test_TopsSplitAnalyzer_data3_all_vv():
    s1 = TopsSplitAnalyzer(target_subswaths=['iw1', 'iw2', 'iw3'],
                           polarization='vv')
    s1.load_safe(safe_path=data3)

    ########################################################################
    # Check metadata list. All 6 items should be loaded regardless of user
    # input
    ########################################################################

    expected = [
        os.path.join(TEST_DIR, 'data3', 'S1A_IW_SLC__1SDV_20200724T034334_20200724T034401_033591_03E49D_96AA.SAFE', 'annotation', 's1a-iw1-slc-vh-20200724t034334-20200724t034359-033591-03e49d-001.xml'),
        os.path.join(TEST_DIR, 'data3', 'S1A_IW_SLC__1SDV_20200724T034334_20200724T034401_033591_03E49D_96AA.SAFE', 'annotation', 's1a-iw1-slc-vv-20200724t034334-20200724t034359-033591-03e49d-004.xml'),
        os.path.join(TEST_DIR, 'data3', 'S1A_IW_SLC__1SDV_20200724T034334_20200724T034401_033591_03E49D_96AA.SAFE', 'annotation', 's1a-iw2-slc-vh-20200724t034335-20200724t034400-033591-03e49d-002.xml'),
        os.path.join(TEST_DIR, 'data3', 'S1A_IW_SLC__1SDV_20200724T034334_20200724T034401_033591_03E49D_96AA.SAFE', 'annotation', 's1a-iw2-slc-vv-20200724t034335-20200724t034400-033591-03e49d-005.xml'),
        os.path.join(TEST_DIR, 'data3', 'S1A_IW_SLC__1SDV_20200724T034334_20200724T034401_033591_03E49D_96AA.SAFE', 'annotation', 's1a-iw3-slc-vh-20200724t034336-20200724t034401-033591-03e49d-003.xml'),
        os.path.join(TEST_DIR, 'data3', 'S1A_IW_SLC__1SDV_20200724T034334_20200724T034401_033591_03E49D_96AA.SAFE', 'annotation', 's1a-iw3-slc-vv-20200724t034336-20200724t034401-033591-03e49d-006.xml')
    ]

    actual = s1.metadata_file_list
    assert Counter(expected) == Counter(actual), 'Metadata list does not match'
    ...
    for item in out_shp_items:
        expected = True
        actual = os.path.exists(item)
        assert actual == expected, f'Shapefile was not generated correctly. ' \
                                   f'Missing: {item}'
    ...
    assert isinstance(data,
                      dict) == True, 'Error when loading JSON as Python ' \
                                     'dictionary'
    ...
    expected = {'burst': 1, 'subswath': 'IW1'}
    actual = data['features'][0]['properties']
    assert expected == actual, f'JSON features with ID 0 do not ma' \
                               f'tch. Actual is {actual}. Expected is {expected}'
    # Test id 23
    expected = {'burst': 6, 'subswath': 'IW3'}
    actual = data['features'][23]['properties']
    assert expected == actual, f'JSON features with ID 23 do not match. ' \
                               f'Actual is {actual}. Expected is {expected}'
    ...
    expected = 27
    actual = len(df)
    assert expected == actual, f'CSV file does not match. Actual is ' \
                               f'{actual} rows. Expected {expected} rows'

    # Check id 0
    expected = 'IW1'
    actual = df.iloc[0]['subswath']
    assert expected == actual, f'Subswath for row 0 does not match. ' \
                               f'Actual is {actual}. Expected is {expected}'

    expected = 1
    actual = df.iloc[0]['burst']
    assert expected == actual, f'Burst for row 0 does not match. Actual ' \
                               f'is {actual}. Expected is {expected}'
...
# Using data3 folder
def test_TopsSplitAnalyzer_data3_all_vh():
